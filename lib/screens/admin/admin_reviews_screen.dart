...
class _AdminReviewsScreenState extends State<AdminReviewsScreen> {
  ...
  void initState() {
    super.initState();
    _loading = false; // 처음엔 비워두고, 사용자가 ID 입력해서 조회
  }
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final data = await _api.adminGetReviews(
        ...
        rating: _ratingFilter, // 서버가 무시해도 클라이언트에서 후처리
      );
                  ...
                  children: [
                    ...
                    DropdownButton<int?>(
                      ...
                      items: const <DropdownMenuItem<int?>>[
                        DropdownMenuItem<int?>(value: null, child: Text('평점: 전체')),
  ...
  Widget _buildReviewTile(ColorScheme cs, Map<String, dynamic> r) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: _loading
            ...
            : RefreshIndicator(
                onRefresh: _load,
                child: (_error != null && _reviews.isEmpty)
                    ? ListView(
                    ...
                    : (_reviews.isEmpty)
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (context, i) {
                              ...
                              return _buildReviewTile(cs, _reviews[i - 1]);
                            },
                          ),
              ),
      ),
